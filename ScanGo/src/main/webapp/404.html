                            ...
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                <div class="currency-wrapper">
                                    <button type="button" class="currency-btn btn-reset text-white"
                                        ...
                                        <img class="flag" src="assets/img/flag/usd.jpg" alt="flag">
                                        <span>USD</span>
                                        <span>
                                    ...
                                    <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                        ...
                                        <li class="currency-list-item ">
                                            <a class="currency-list-option" href="#" data-value="CAD">
                                                <img class="flag" src="assets/img/flag/cad.jpg" alt="flag">
                                                <span>CAD</span>
                                            </a>
                                        </li>
                                        <li class="currency-list-item ">
                                            <a class="currency-list-option" href="#" data-value="EUR">
                                                <img class="flag" src="assets/img/flag/eur.jpg" alt="flag">
                                                <span>EUR</span>
                                            </a>
                                        </li>
                                        <li class="currency-list-item ">
                                            <a class="currency-list-option" href="#" data-value="JPY">
                                                <img class="flag" src="assets/img/flag/jpy.jpg" alt="flag">
                                                <span>JPY</span>
                                            </a>
                                        </li>
                                        <li class="currency-list-item ">
                                            <a class="currency-list-option" href="#" data-value="GBP">
                                                <img class="flag" src="assets/img/flag/gbp.jpg" alt="flag">
                                                <span>GBP</span>
                                            </a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        <div
                                                            ...
                                                            <a class="mega-menu-img nav-link-sub nav-text-sub"
                                                                href="collection-left-sidebar.html">
                                                                <img class="menu-img" src="assets/img/menu/1.jpg" alt="menu">

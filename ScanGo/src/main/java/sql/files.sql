...
-- PRODUCT ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('一匙靈洗衣精補充包', 86, '包', 1, 50, '/ScanGo/image/product/一匙靈制菌超濃縮洗衣精補充包1.9Kg.png', 'A-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('妙管家馬桶清潔劑', 57, '瓶', 1, 30, '/ScanGo/image/product/妙管家馬桶芳香清潔劑-香水百合750g.png', 'A-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('泡舒洗潔精-檸檬', 89, '瓶', 1, 25, '/ScanGo/image/product/泡舒洗潔精-檸檬1000g.png', 'A-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('威猛先生快速通樂', 75, '瓶', 1, 30, '/ScanGo/image/product/威猛先生快速通樂960cc.png', 'A-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('OP無雙酚A鋁箔', 107, '個', 2, 50, '/ScanGo/image/product/OP無雙酚A鋁箔1500cm.png', 'B-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('排水口濾渣網', 76, '包', 2, 100, '/ScanGo/image/product/日光生活排水口濾渣網(約200入).png', 'B-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('妙潔耐熱袋量販包', 72, '盒', 2, 50, '/ScanGo/image/product/妙潔耐熱袋量販包(六兩)345入.png', 'B-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('楓康耐熱袋大', 68, '盒', 2, 50, '/ScanGo/image/product/楓康耐熱袋大140入.png', 'B-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('五月花妙用廚房紙巾', 94, '組', 3, 70, '/ScanGo/image/product/五月花妙用廚房紙巾-6捲.png', 'C-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('好韌真3層衛生紙', 125, '組', 3, 70, '/ScanGo/image/product/倍潔雅好韌真3層抽取衛生紙100抽6包.png', 'C-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('嬰兒潔膚濕巾量販包', 169, '包', 3, 130, '/ScanGo/image/product/家樂福嬰兒潔膚濕巾量販包(粉紅)80PCx4.png', 'C-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('舒潔迪士尼衛生紙', 345, '串', 3, 30, '/ScanGo/image/product/舒潔迪士尼抽取衛生紙超值包.png', 'C-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('可口可樂', 35, '瓶', 4, 70, '/ScanGo/image/product/可口可樂 600ml.png', 'D-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('黑松加鹽沙士', 30, '瓶', 4, 30, '/ScanGo/image/product/黑松加鹽沙士 600ml.png', 'D-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('舒味思通寧汽水', 38, '罐', 4, 30, '/ScanGo/image/product/舒味思通寧汽水 330ml.png', 'D-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('黑松汽水', 30, '瓶', 4, 30, '/ScanGo/image/product/黑松汽水 600ml.png', 'D-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('Pocky牛奶餅乾棒', 79, '包', 5, 300, '/ScanGo/image/product/Pocky百奇牛奶餅乾棒.png', 'E-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('海太加鈣營養餅乾', 57, '盒', 5, 100, '/ScanGo/image/product/海太加鈣營養餅乾.png', 'E-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('能多益餅乾', 59, '包', 5, 150, '/ScanGo/image/product/能多益餅乾.png', 'E-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('樂事美國經典原味', 45, '包', 5, 130, '/ScanGo/image/product/樂事美國經典原味.png', 'E-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('味丹青草茶', 25, '瓶', 6, 30, '/ScanGo/image/product/味丹青草茶 560ml.png', 'F-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('原味本舖養身杏仁茶', 35, '罐', 6, 30, '/ScanGo/image/product/原味本舖養身杏仁茶240ml.png', 'F-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('悅氏麥仔茶', 25, '瓶', 6, 30, '/ScanGo/image/product/悅氏麥仔茶550ml.png', 'F-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('統一麥香奶茶', 10, '瓶', 6, 300, '/ScanGo/image/product/統一麥香奶茶.png', 'F-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('多功能暖風機', 4888, '台', 7, 5, '/ScanGo/image/product/【Philips 飛利浦】多功能暖風機 烘鞋_烘被_烘衣_暖風機_陶磁電暖器 (AHR3124FM).png', 'G-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('14吋立扇SL-1406', 788, '台', 7, 3, '/ScanGo/image/product/【SDL 山多力】14吋立扇SL-1406.png', 'G-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('12吋鹵素燈電暖器', 1688, '台', 7, 3, '/ScanGo/image/product/【亞普牌】12吋鹵素燈電暖器(HY-213).png', 'G-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('森活電蚊拍(三層網)', 95, '個', 7, 15, '/ScanGo/image/product/森活電蚊拍(三層網)-顏色隨機出貨尺寸：約46_18cm.png', 'G-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('小海葵纖體按摩棒', 988, '個', 8, 15, '/ScanGo/image/product/Comefree 小海葵纖體按摩棒.png', 'H-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('大風量負離子吹風機', 799, '台', 8, 10, '/ScanGo/image/product/TESCOM TID450TW大風量負離子吹風機.png', 'H-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('康生雙持高效筋膜槍', 889, '台', 8, 10, '/ScanGo/image/product/康生雙持高效筋膜槍(智慧感壓).png', 'H-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('活力亮潔電動牙刷', 999, '支', 8, 30, '/ScanGo/image/product/德國百靈Oral-B D100活力亮潔電動牙刷.png', 'H-4');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('不挑鍋黑晶爐', 2088, '個', 9, 5, '/ScanGo/image/product/【PHILIPS 飛利浦】不挑鍋黑晶爐(HD4988).png', 'I-1');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('不鏽鋼電茶壺', 888, '個', 9, 3, '/ScanGo/image/product/【TATUNG大同】1.8公升不鏽鋼電茶壺(TEK-1815S).png', 'I-2');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('微電腦電熱水瓶', 2790, '個', 9, 10, '/ScanGo/image/product/【TIGER 虎牌】日本製 微電腦電熱水瓶3L(PDR-S30R).png', 'I-3');
insert into product(productName, price, unit, categoryId, inventory, picture, position) values('大同電鍋', 2688, '個', 9, 2, '/ScanGo/image/product/大同電鍋TAC-10L-DCU10人份.png', 'I-4');
...
-- USER ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
insert into user(userName, password, email, phone, birthday, levelId, authType, createDate) values('admin', '$2a$10$JSfM9nCScx71EfKemrdsKepMNJXItZZ3bI9g33FtUQkGN5hyxv5zi', 'admin@gmail.com', '0945772213', '1979-12-26', 2, 'ScanGo','2024-12-01');
insert into user(userName, password, email, phone, birthday, levelId, authType, createDate) values('admin2', '$2a$10$JSfM9nCScx71EfKemrdsKepMNJXItZZ3bI9g33FtUQkGN5hyxv5zi', 'admin2@gmail.com', '0945772213', '1979-12-26', 2, 'ScanGo','2024-12-01');
